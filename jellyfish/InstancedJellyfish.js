...
window.InstancedJellyfish = (function(){
    ...
    InstancedJellyfish.prototype.createAndFillBuffers = function(data){
        ...
        GL.enableVertexAttribArray(this.program.attributes.offsetBuffer);
    ...
    InstancedJellyfish.prototype.bufferVertexAttributes = function(){
        GL.bindBuffer(GL.ARRAY_BUFFER, this.offsetBuffer);
        GL.vertexAttribPointer(this.program.attributes.offset, 3, GL.FLOAT, GL.FALSE, Float32Array.BYTES_PER_ELEMENT*3, 0);
        GLext.vertexAttribDivisorANGLE(this.program.attributes.offset, 1);
    ...
    InstancedJellyfish.prototype.render = function(){
        ...
        GLext.drawElementsInstancedANGLE(GL.TRIANGLES, this.indexcount, GL.UNSIGNED_INT, 0,66);
    };
