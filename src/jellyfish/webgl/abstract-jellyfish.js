...
import {CAMERA, USE_FOG,SCALE,CENTER, ROTATE} from '../../data/const.js'
...
class AbstractJellyfish extends Timer{
  ...
  updateUniforms(){
    ...
    mat4.translate(modelMatrix,modelMatrix,   [0.0, CENTER.y, CENTER.z]);
    mat4.rotate(modelMatrix,modelMatrix,      glMatrix.toRadian(Math.sin(this.rotation / 10.0) * 30.0 * ROTATE.y),   [0.0, 1.0, 0.0]);
    mat4.rotate(modelMatrix,modelMatrix,      glMatrix.toRadian(Math.sin(this.rotation / 20.0) * 30.0 * ROTATE.x),   [1.0, 0.0, 0.0]);
