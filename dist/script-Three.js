...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ThreeAbstractJellyfish = __webpack_require__(24);

	var _ThreeAbstractJellyfish2 = _interopRequireDefault(_ThreeAbstractJellyfish);

	var _ThreeInstancedJellyfish = __webpack_require__(25);

	var _ThreeInstancedJellyfish2 = _interopRequireDefault(_ThreeInstancedJellyfish);

	var _ThreeSingleJellyfish = __webpack_require__(26);

	var _ThreeSingleJellyfish2 = _interopRequireDefault(_ThreeSingleJellyfish);
	...
	var main = function main(data) {
	  ...
	  gui.add(text, 'class', ["Single", "Instanced"]).name("Class").onChange(function (value) {
	    ...
	    switch (value) {
	      case "Single":
	        jellyfishCount = 1;
	        refresh(_ThreeSingleJellyfish2.default, jellyfishCount);
	        break;
	      case "Instanced":
	        jellyfishCount = 3;
	        refresh(_ThreeInstancedJellyfish2.default, jellyfishCount);
	        break;
	      default:
	  ...
	  refresh(_ThreeSingleJellyfish2.default, 1); // Launch the initial benchmark with a single jellyfish
	  ...
	  function refresh(BenchmarkClass, jellyfishCount) {
	    ...
	    var camera = new THREE.PerspectiveCamera(_const.CAMERA.ANGLE, window.innerWidth / window.innerHeight, _const.CAMERA.NEAR, _const.CAMERA.FAR); //In degrees not radians

	    var benchmark = new BenchmarkClass(data.jellyfish);
	    var gradient = new _ThreeGradient2.default(data.gradient);

	    benchmark.geometry.maxInstancedCount = jellyfishCount;
	    handle.jellyfishCount = gui.add(benchmark.geometry, 'maxInstancedCount', 1, _const.MAX_NUMBER).name("Number").step(1);
	...
	var object_promise = {
	  gradient: {
	    shaders: { VS: __webpack_require__(22), FS: __webpack_require__(23) }
	  },
	  jellyfish: {
	    ...
	    imagesList: __webpack_require__(18)
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ThreeAbstractJellyfish = function (_Timer) {
	  _inherits(ThreeAbstractJellyfish, _Timer);

	  /**
	   * Constructor for a Jellyfish in THREE.JS.
	   */
	  function ThreeAbstractJellyfish(jellyfish) {
	    _classCallCheck(this, ThreeAbstractJellyfish);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ThreeAbstractJellyfish).call(this));

	    _this.x = 0;
	    _this.y = 0;
	    _this.z = 0;
	    _this.createGeometry();
	    _this.addAttribute(jellyfish);
	    _this.geometry.setIndex(new THREE.BufferAttribute(new Uint32Array(jellyfish.index), 1));
	    _this.textures = (0, _util.getTexturesJellyfish)(jellyfish.imagesList);
	    _this.createMaterial(jellyfish);

	    _this.mesh = new THREE.Mesh(_this.geometry, _this.material);
	    _this.mesh.scale.set(5, 5, 5); // equivalent to mat4.scale(uWorld,uWorld, [5.0, 5.0, 5.0]);
	    //But the changes only take effect at rendering time so *5 on translateY
	    _this.rotation = 0;
	    return _this;
	  }

	  _createClass(ThreeAbstractJellyfish, [{
	    key: 'createGeometry',
	    ...
	    key: 'addAttribute',
	    value: function addAttribute(jellyfish) {
	    ...
	    key: 'createMaterial',
	    value: function createMaterial(jellyfish) {
	      this.material = new THREE.ShaderMaterial({
	        ...
	        transparent: true,
	        defines: { USE_FOG: _const.USE_FOG },
	        uniforms: {
	  ...
	  return ThreeAbstractJellyfish;
	}(_Timer3.default);

	exports.default = ThreeAbstractJellyfish;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** A jellyfish using ThreeJS. */
	var ThreeInstancedJellyfish = function (_ThreeAbstractJellyfi) {
	  _inherits(ThreeInstancedJellyfish, _ThreeAbstractJellyfi);

	  function ThreeInstancedJellyfish() {
	    _classCallCheck(this, ThreeInstancedJellyfish);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ThreeInstancedJellyfish).apply(this, arguments));
	  }

	  _createClass(ThreeInstancedJellyfish, [{
	    key: 'createGeometry',
	    value: function createGeometry() {
	    ...
	    key: 'addAttribute',
	    value: function addAttribute(jellyfish) {
	      _get(Object.getPrototypeOf(ThreeInstancedJellyfish.prototype), 'addAttribute', this).call(this, jellyfish);
	      var offset = [];
	    ...
	    key: 'createMaterial',
	    value: function createMaterial(jellyfish) {
	      _get(Object.getPrototypeOf(ThreeInstancedJellyfish.prototype), 'createMaterial', this).call(this, jellyfish);
	      this.material.defines.USE_INSTANCED = true;
	    }
	  }]);

	  return ThreeInstancedJellyfish;
	}(_ThreeAbstractJellyfish2.default);

	exports.default = ThreeInstancedJellyfish;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** A jellyfish using ThreeJS. */
	var ThreeSingleJellyfish = function (_ThreeAbstractJellyfi) {
		_inherits(ThreeSingleJellyfish, _ThreeAbstractJellyfi);

		function ThreeSingleJellyfish(data) {
			_classCallCheck(this, ThreeSingleJellyfish);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ThreeSingleJellyfish).call(this, data));

			_this.geometry.maxInstancedCount = 1; // Just to match with Instanced class property
			return _this;
		}

		return ThreeSingleJellyfish;
	}(_ThreeAbstractJellyfish2.default);

	exports.default = ThreeSingleJellyfish;
